...
# Paleta de Colores Blindada (Bajo Contraste)
...
st.markdown(f"""
    ...
    /* 2. ELIMINAR BARRAS BLANCAS (Expanders) */
    ...
    /* 3. SELECTORES Y DROPDOWNS (Eliminar Blanco) */
    ...
    /* 4. INPUTS Y CANTIDAD (Cero bordes claros) */
...
DB_MASAS = {
    ...
    "Masa Brioche Rosca": {"receta": {"Harina de fuerza": 100, "Azúcar": 25, "Miel": 3, "Mantequilla sin sal": 30, "Huevo": 20, "Yemas": 4, "Leche entera": 24, "Levadura": 0.35, "Sal fina": 2.2, "Agua Azahar": 0.6}, "merma": 1.0, "tz_ratio": 0.025, "tz_liq": 1},
    "Masa Muerto Tradicional": {"receta": {"Harina de fuerza": 100, "Leche entera": 25, "Yemas": 24, "Claras": 16, "Azúcar": 20, "Mantequilla sin sal": 25, "Sal fina": 2, "Levadura": 3}, "merma": 1.0},
    "Masa Muerto Guayaba": {"receta": {"Harina de fuerza": 100, "Leche entera": 30, "Yemas": 18, "Claras": 12, "Azúcar": 20, "Mantequilla sin sal": 25, "Levadura": 5, "Sal fina": 1.8, "Polvo Guayaba": 5}, "merma": 1.0, "huesos": True},
    "Mezcla Brownie": {"receta": {"Mantequilla sin sal": 330, "Azúcar Blanca": 275, "Mascabado": 120, "Chocolate": 165, "Harina de fuerza": 190, "Cocoa": 75, "Sal fina": 8}, "merma": 1.0, "fijo": True}
}
...
if st.session_state.comanda:
    ...
    with t_res:
        for m_id, items in lotes_masa.items():
            ...
            # --- CORRECCIÓN KEYERROR Y CÁLCULO MASA ---
            m_batch_gr = 0
            for it in items:
                p_u = (ARBOL[it['fam']].get("tamaños", {})[it['tam']])
                m_batch_gr += (p_u * it['cant']) / m_dna['merma']
